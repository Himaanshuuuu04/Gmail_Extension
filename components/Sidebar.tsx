...
export const Sidebar: React.FC<{ surface?: Surface }> = ({
  surface = "gmail",
}) => {
  ...
  if (isChat) {
    return (
      <div className={`aira-sidebar chat ${collapsed ? "collapsed" : ""}`}>
        <button
          className="aira-sidebar-toggle"
          onClick={() => setCollapsed(!collapsed)}
          title={collapsed ? "Expand AIRA Insight" : "Collapse AIRA Insight"}
        >
          {collapsed ? "◀" : "▶"}
        </button>

        <div className="aira-sidebar-content">
          <div className="sidebar-header-card chat">
            <div className="aira-sidebar-title">AIRA Insight</div>
            <div className="aira-sidebar-subtitle">
              Three types. Each with a unique cue.
            </div>
          </div>

          <div className="sidebar-card ownership chat featured">
            ...
            <div className="sidebar-card-body">
              ...
              <div className="sidebar-card-cues">
                <span>
                  <strong>Where:</strong> Near latest message
                </span>
                <span>
                  <strong>Why:</strong> Action needs ownership
                </span>
              </div>
            </div>
          </div>

          <div className="sidebar-footer chat">
            ...
            <div className="sidebar-footer-content">
              ...
              <div className="sidebar-footer-desc">
                A lighter rail keeps the assistant useful without competing with
                the conversation.
              </div>
            </div>
          </div>
      ...
      <div className="aira-sidebar-content">
        ...
        <div className="sidebar-card decision">
          ...
          <div className="sidebar-card-body">
            ...
            <div className="sidebar-card-desc">
              Discussion active, but no decision detected.
            </div>
            <div className="sidebar-card-cues">
              <span>
                <strong>Where:</strong> Between messages
              </span>
              <span>
                <strong>Why:</strong> Clarity needed
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="sidebar-card followup">
          ...
          <div className="sidebar-card-body">
            ...
            <div className="sidebar-card-desc">
              Good time to follow up to maintain momentum.
            </div>
            <div className="sidebar-card-cues">
              <span>
                <strong>Where:</strong> Near reply box
              </span>
              <span>
                <strong>Why:</strong> Timely follow-up helps
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="sidebar-footer">
          ...
          <div className="sidebar-footer-content">
            <div className="sidebar-footer-title">Why subtle?</div>
            <div className="sidebar-footer-desc">
              Subtle colors reduce alert fatigue and build long-term trust.
            </div>
          </div>
        </div>
      </div>
